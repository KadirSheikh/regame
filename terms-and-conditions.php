...
<body>
  ...
  <?php include 'common/nav.php'; ?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="container">
            <div class="terms-and-condtions">
              <h1>TERMS & CONDTIONS</h1>
              <p>
                These terms and conditions of use (“Terms”) along with privacy
                policy (“Privacy Policy”) forms a legally binding agreement
                (“Agreement”) between You and us.
              </p>
              <p>
                Hence, We insist that You read these Terms and Privacy Policy
                and let Us know if You have any questions regarding the same. We
                will try Our best to answer Your queries.
              </p>
              <h3>A. USERS’ APPROVAL</h3>
              <hr class="terms-and-condtions-line" />
              <h4>1. Users approve of and accept over Agreement by:</h4>
              <p>(a) reading all terms and condition</p>
              <p>(b) reading all rules of this app</p>
              <h4>2. Users may accept this Agreement only if:</h4>
              <p>
                (a) if such User is a natural Person, is of the legal age (18
                years or olders), eligibility and mental capacity to form a
                binding contract with us.
              </p>
              <p>
                (b) if such User is a not a resident of Telangana, Assam,
                Orissa, Kerala, Sikkim, Nagaland or Gujarat.
              </p>
              <p>
                (c) if such User is a juristic Person, is lawfully existing and
                has all the authorizations, permits and allowances to enter into
                this Agreement and form a binding contract.
              </p>
              <p>
              ...
              <div class="provision-of-the-app">
                <h3>B. PROVISION OF THE APP</h3>
                <hr class="terms-and-condtions-line" />
                <h4>
                ...
                <h4>
                  ...
                  our platform is ‘Games of Skill’, under Indian law, and that
                  we does not support, endorse or offer to Users ‘games of
                  chance’ for money. While ‘Games of Skill’ do not have a
                  comprehensive definition, they are those games where the
                  impact of a player’s effort and skill on the outcome of a game
                  is higher than the impact of luck and chance.
                </h4>
                <h4>
                  3. It may be noted that States are permitted, by the Indian
                  Constitution, to enact laws regulating betting and gambling in
                  their respective jurisdictions. In furtherance of these
                ...
                <h4>
                  ...
                  the outcome / success in the games is directly dependent on
                  the User’s effort, performance and skill. By choosing how to
                  play, the actions of Users shall have direct impact on the
                  game.
                </h4>
                <h4>
              ...
              <div class="game-rule">
                ...
                <p>
                  (c) if match is not started and both parties doesn't want to
                  play, select ‘Cancel’ option.
                </p>
                <h4>
                  3. Posting a wrong result after game, will charge you a
                  penality of ₹50.
                </h4>
                <h4>
                  4. User must have to record every game, and if any player is
                  hacking or cheating a game, contact support.
                </h4>
                <h4>
                  5. If game is not started, if you haven't played a single move
                  yourself, please show the recording of game to support. Game
                  will be cancelled only if you have recording.
                </h4>
                <h4>
                  6. If you don't have any proof against player cheating and
                  error in game, you will be considered as lost.
                </h4>
              </div>
              <div class="deposit-withdrawal">
                <h3>D. DEPOSIT / WITHDRAWAL</h3>
                <hr class="terms-and-condtions-line" />
                <h4>
                  1. Player can deposit there balance in Load Balance section.
                </h4>
                <h4>
                  2. Player can take withdrawal by setting a withdrawal request
                  on your app.
                </h4>
                <h4>
                  3. Deposit and withdrawal request completed by support at any
                  time.
                </h4>
                <h4>
                ...
                <h4>
                  5. Once withdrawal is done, you don't have any authority to
                  raise any query.
                </h4>
                <h4>
              ...
              <div class="commission-charges">
                <h3>E. COMMISSION CHARGES</h3>
                <hr class="terms-and-condtions-line" />
                <h4>
                  1. Challenge below 50, flat ₹5 RS will be charged on challenge
                  total amount.
                </h4>
                <h4>
                  2. Challenge between ₹50 to ₹250, flat ₹5% commission will be
                  charged on total amount.
                </h4>
                <h4>
                  3. Challenge between ₹250 to ₹500, flat ₹25 Rs commission will
                  be charged on total amount.
                </h4>
                <h4>
                  4. Challenge above ₹500, flat 2.5% commission will be charged
                  on total amount.
                </h4>
              </div>
            </div>
